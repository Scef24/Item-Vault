...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        try {
            $stmt = $pdo->prepare("INSERT INTO items (title, category_id, description, date_item, location_found, image, type, status, user_id) VALUES (?, ?, ?, ?, ?, ?, 'found', 'pending', ?)");
            $stmt->execute([$title, $category_id, $description, $date_found, $location, $image_path, $_SESSION['user_id']]);
            
            $_SESSION['success'] = "Found item posted successfully!";
    ...
    <div class="sidebar">
        ...
        <div class="main-content">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn">Post Found Item</button>
            </form>
        </div>
    </div>
</body>
